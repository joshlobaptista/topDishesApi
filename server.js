    ...
    if('restaurant' in params){
      ...
      if(restaurant == 'Banyan'){
        ...
        var objToJson = {
          ...
          ingredients: "Ingredients: beef tenderloin | radicchio | lime | black pepper"
        }
        ...
        var objToJson = {
          ...
          price: "Price: $32.00",
          dish: "Dish: Paccheri",
          ingredients: "Ingredients: lobster | green onion | tomato"
        ...
        var objToJson = {
          ...
          ingredients: "Ingredients: Fennel | Citrus salad | Sauce caramello"
        }
        res.end(JSON.stringify(objToJson));
      }
        ...
        var objToJson = {
          ...
          ingredients: "Ingredients: Smoked Cherry Salsina | Turnip Butter | Grilled Carrots"
        }
        res.end(JSON.stringify(objToJson));
      }
        ...
        var objToJson = {
          ...
          ingredients: "Ingredients: Coconut Carrot Flan | French Lentils"
        }
        res.end(JSON.stringify(objToJson));
      }
